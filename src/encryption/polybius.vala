...
class PolybiusTable.Table : Object {
    ...
    public PolybiusTable.Indexes get_letter_indexes (unichar letter) throws Encryption.OOBError{
        PolybiusTable.Indexes indexes = new PolybiusTable.Indexes();
    ...
    public unichar get_letter_by_indexes (PolybiusTable.Indexes indexes) throws Encryption.OOBError {
...
class PolybiusTable.Indexes : Object {
    public int row { get; set; }
    public int column { get; set; }
}

class Encryption.Polybius : Object {
    public static string encrypt(Encryption.Alphabet alphabet, string phrase, int rows, int columns) throws Encryption.OOBError {
        string result = "";
        PolybiusTable.Indexes indexes;
        PolybiusTable.Table table;
        try {
            table = new PolybiusTable.Table (alphabet, rows, columns);
        }
